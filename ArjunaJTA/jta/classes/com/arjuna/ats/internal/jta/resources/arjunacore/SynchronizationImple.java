...
public class SynchronizationImple implements SynchronizationRecord, Comparable {
    ...
    /*
     * SyncronizationsImples are ordered first according to the isInterposed
     * property and then by Uid. Interposed synchronizations must come after
     * non-interposed ones (see TwoPhaseCoordinator and
     * TransactionSynchronizationRegistry) The ordering within the
     * interposed/non-interposed categories is arbitrary but must be defined for
     * correct functioning of the sort. Just don't rely on it in application level
     * code.
     *
     * @param object
     *
